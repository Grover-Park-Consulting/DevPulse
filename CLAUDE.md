...
Agree on what needs to be built before touching any code. Vague tasks produce poor results; the discipline of defining scope before starting compounds across the whole project.
...
access_be/
  DevPulseACE.accdb.src/  VCS export — Access BE edition front end
